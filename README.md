...
In this repo you can find the code used to implement a monitoring system on Jetson Nano, that tracks the flow of people using digital image processing techniques and deep learning. You can review our post [*People counting on Jetson Nano*](https://asesoftware-my.sharepoint.com/personal/ndiaz_asesoftware_com/Documents/WhoAmEye/Art%C3%ADculo4-Resultados.docx?web=1) for all the details of the project.

## Hardware and software used
For the development of this monitoring system we used a *Jetson Nano Developer Kit A01*, as well as a *Logitech HD Pro C920 webcam* with 1080p resolution for video capture. The monitoring algorithms were implemented in Python 3.6 using OpenCV and Jetson Utils. You can find more information about the NVIDIA Jetson environment in the following table:
...
We can divide this application into two main tasks: people detection and object tracking. First, we use a deep learning model and digital image processing techniques to detect moving people and get their location in a particular frame. We then save the detection’s bounding boxes and centroids and then keep track of their movement over the following frames using object tracking algorithms. You can review our posts about detection [*People detection using Jetson Inference and OpenCV*](https://asesoftware-my.sharepoint.com/personal/ndiaz_asesoftware_com/Documents/WhoAmEye/Art%C3%ADculo2-Detecci%C3%B3n.docx?web=1) and tracking [*Object tracking and counting using Python*](https://asesoftware-my.sharepoint.com/personal/ndiaz_asesoftware_com/Documents/WhoAmEye/Art%C3%ADculo3-Tracking.docx?web=1) to see the details and test this **people counting system**.
